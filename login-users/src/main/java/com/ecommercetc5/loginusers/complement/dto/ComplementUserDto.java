...
public record ComplementUserDto(
    Long id,
    ...
    public static Complement toEntity(ComplementUserDto dto, User user) {
        return new Complement(dto, user);
    }

    public static ComplementUserDto fromEntity(Complement complement) {
        return  new ComplementUserDto(
                complement.getId(),
                complement.getName(),
                complement.getPhone(),
                ...
                complement.getUser() != null ? new UserDto(complement.getUser()) : null
        );
    }

    public static Complement mapperDtoToEntity( ComplementUserDto dto, Complement entity, User user ) {
